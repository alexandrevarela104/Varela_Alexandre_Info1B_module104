...
class Toolsbd:
    ...
    def __init__(self):
        ...
        self.name_fichier_dump_sql_bd = "../database/varela_tavares_alexandre_info1b_gestion_de_facture.sql"
    ...
    def connect_database(self):
        """
            ...
            1) Récupérer le nom de la BD dans le fichier DUMP en MySql "varela_tavares_alexandre_info1b_gestion_de_facture.sql"
